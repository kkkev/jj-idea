...
2. **Bookmark Management & Branches Panel** — Interactive bookmark decorations, pending-deletion visibility, distinguishing local from tracked-remote drift, and a dedicated branches panel (the main-toolbar bookmark widget has shipped)
