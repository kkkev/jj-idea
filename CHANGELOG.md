...
- A commit whose parent has been filtered out of view, or falls beyond the configured log limit, now shows a wiggly line down from its circle instead of no connector at all — which looked identical to a true repository root.
