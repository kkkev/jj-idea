...
- Four new settings under Settings → Version Control → Jujutsu:
  - A checkbox to turn off the log row hover tooltip, for anyone who finds it more distracting than useful now that the details pane covers the same info on selection. ([#51](https://github.com/kkkev/jj-idea/issues/51), [#75](https://github.com/kkkev/jj-idea/issues/75))
