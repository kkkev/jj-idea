...
- The bookmarks panel always showed remote bookmarks with the "tracked" icon and never showed ahead/behind divergence, regardless of the actual state — an untracked remote bookmark's context menu also always offered "Untrack" instead of "Track". ([#48](https://github.com/kkkev/jj-idea/issues/48))
