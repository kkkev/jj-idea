...
/**
 * Build ≥ 261 (2026.1+) variant of the `getForcedCommitMode`/`JujutsuHiddenCommitMode` tests -
 * see the `kotlin-commitModeOld`/`kotlin-commitModeNew` source-set switch in build.gradle.kts
 * (jj-idea-r5jf).
 */
